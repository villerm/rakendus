...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="http://localhost/Kool/Veebirakendus/rakendus/">Veebirakendused</a>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a class="dropdown-item" href="index.php">Uudised</a>
          <a class="dropdown-item" href="./activity.php">Logid</a>
        </div>
      </li>
      <li class="nav-item">
